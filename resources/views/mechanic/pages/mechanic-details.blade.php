                    ...
                    <div class="camaro-info">
                        ...
                        <div class="camaro-location">
                            <div class="camaro-location-inner">
                                <i class="bx bx-map"></i>
                                <span>Location : {{ $mechanic->street_address }}, {{ $mechanic->town_city }}, {{ $mechanic->state }}, {{ $mechanic->country }}</span>
                            </div>
                            <div class="camaro-location-inner">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <div class="detail-product">
                    ...
                    <div class="detail-bigimg">
                        <div class="product-img">
                            <img src="{{ asset('storage/uploads/mechanic/'. $mechanic->logo) }}" style="width: 100%" class="img-fluid" alt="Slider">
                        </div>
                    </div>
                </div>
                ...
                <livewire:mechanic.components.mechanic.rating :id="$mechanic->id"/>
            ...
            <div class="col-lg-4 theiaStickySidebar">
                ...
                <div class="review-sec extra-service mt-0">
                    ...
                    <div class="owner-detail">
                        <div class="owner-img">
                            <a href="#"><img src="{{ asset('storage/uploads/mechanic/' . $mechanic->logo) }}" alt="User"></a>
                            <span class="badge-check"><img src="{{ asset('assets/user/img/icons/badge-check.svg') }}"
                                    alt="User"></span>
                        </div>
                    ...
                    <ul class="booking-list">
                        ...
                        <li>
                            Location
                            <span>{{ $mechanic->street_address }}, {{ $mechanic->town_city }}, {{ $mechanic->state }}, {{ $mechanic->country }}</span>
                        </li>
                    </ul>
                    <div class="message-btn">
                        <a href="tel:{{ $mechanic->phone_number }}" class="btn btn-order">Call Now</a>
                        <a href="wa.me/{{ $mechanic->phone_number }}" class="chat-link"><i class="fa-brands fa-whatsapp"></i>Chat Via Whatsapp</a>
                    </div>
                </div>
            </div>
        </div>
